  ...
  return (
    <div className="main-bg-img">
     ...
     <div className=" Main_container_2">
      ...
      <div className="Main_Latest_cont   justify-content-center mx-auto lg:col-12 md:col-12 col-12 " style={{ position: "relative" , backgroundColor:"white",maxWidth:"78rem" }}>
        ...
        >
          ...
          >
            <Image src="/new-img.png" width={54} height={54} alt="new" />
            <h2>Demo Notification</h2>
          </SwiperSlide>
      ...
      <div className=" justify-content-center flex mx-auto flex-main-card lg:col-12"  >
        <div className="card lg:col-6 md:col-12 col-12 ">
          <Card  style={{ backgroundColor: "#e8f4ff" }} className=" border-round-xl ">
            <div className="minus-margin ">
              ...
              <h1 className="Empower_h  ">Empower IAS <span style={{color:"red"}}>Offline Course</span></h1>
        ...
        <div className="card lg:col-6 md:col-12 col-12  ">
            ...
            <div className="minus-margin">
              ...
              <h2 className="Empower_h2 ">Empower IAS  <span style={{color:"red"}}>Online Course</span></h2>
